# Spoodle Space · REST Framework Study

An early Django REST Framework implementation of a dog-community social API.
...
Repository maintained in [Sam O’Brien-Olinger’s GitHub account](https://github.com/SamOBrienOlinger). For a problem or suggested improvement, [open an issue](https://github.com/SamOBrienOlinger/DRFramework/issues) with the affected page or command, steps to reproduce, and expected behaviour.

[Back to top](#spoodle-space--rest-framework-study)
